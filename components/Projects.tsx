...
import AixArtisansThumbnail from "./thumbnails/AixArtisansThumbnail";
import BusLiveThumbnail from "./thumbnails/BusLiveThumbnail";
import SignCastThumbnail from "./thumbnails/SignCastThumbnail";

const THUMBNAIL_MAP: Record<string, React.ComponentType> = {
  aixartisans: AixArtisansThumbnail,
  buslive: BusLiveThumbnail,
  signcast: SignCastThumbnail,
};
    ...
    <motion.div
      ...
      onMouseEnter={(e) => {
        ...
        (e.currentTarget as HTMLDivElement).style.boxShadow =
          "0 0 24px rgba(139,122,184,0.08)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-5 gap-3">
        <div className="flex items-start justify-between gap-2">
          ...
          {project.featured && (
            <span
              className="shrink-0 text-[9px] font-mono px-1.5 py-0.5 rounded-sm"
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="relative py-24 px-6 md:px-12 lg:px-20 max-w-7xl mx-auto overflow-hidden"
    >
      <NeuralBackground />
      <motion.div
