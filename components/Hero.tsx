  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(139,122,184,0.06) 0%, transparent 70%)",
        }}
      />
      ...
      >
        <span className="font-mono text-[10px] text-[var(--foreground)]/30 tracking-widest">
          SCROLL
        </span>
