    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-[var(--foreground)]/50 text-sm font-mono">
          Open to SWE internships, full-time roles, and interesting
          collaborations.
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="flex w-full min-w-0 flex-wrap items-center gap-4 md:gap-6 mt-12 pt-10 border-t"
      ...
      >
        ...
        <a
          ...
          className="flex min-w-0 max-w-full basis-full items-center gap-2 font-mono text-sm break-all transition-colors duration-200 sm:basis-auto"
          style={{ color: "var(--foreground)" }}
          onMouseEnter={(e) => (e.currentTarget.style.color = "var(--accent)")}
          onMouseLeave={(e) =>
            (e.currentTarget.style.color = "var(--foreground)")
